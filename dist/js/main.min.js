...
$("header .cart .total-value-cart").text("R$ 0,00"),$("header .cart .qtd-cart").text("0"),viewProducts(),$(".single-item-banner").slick({dots:!0,speed:900,autoplay:!0}),$(".single-item-banner").on("afterChange",function(e,t,n){$(".banners").attr("class","banners currentSlide"+n)})});